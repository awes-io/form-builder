...
1. [Пример использования компонента](#fbmb-example)
2. [Свойства компонента](#fbmb-options)


## <a name="fbmb-example"></a> Пример использования компонента
...
## <a name="fbmb-options"></a> Свойства компонента
